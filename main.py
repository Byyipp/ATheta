...
def searchforVertex():
    vertexSearch = input("Please type in a vertex coordinate in format: x,y to show its information")
...
if __name__ == '__main__':
    ...
    istheta = False
    while True:
        aortheta = input('Type "a" for A* or "t" for Theta*') # change to raw_input in ilabs
        if aortheta == 'a':
            print("doing A")
            istheta = False
            break
